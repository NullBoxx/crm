...
<script type="text/javascript">
	$(function(){
		...
		$("#openSearchModalBth").click(function () {
		...
		// 为提交 (市场活动) 按钮绑定时间, 填充市场活动源 (填写两项信息 名字 + id)
		...
		$("#converBtn").click(function () {
			...
			* */
			...
			if ($("#isCreateTransaction").prop("checked")) {
				...
				// 以上传递参数的方式很麻烦, 而且表单一旦扩充, 挂在的参数有可能超出浏览器地址栏的上限
				// 我们想到使用提交交易表单的方式来发出本次的传统请求
				// 提交表单的参数不用我们手动挂载 (表单中写name属性), 提交表单能够提交post请求
...
<body>
	...
	<div id="title" class="page-header" style="position: relative; left: 20px;">
		...
		<%--
				...
				其他所有的隐含对象一概不能省略 (如果省略掉了, 会变生从域对象中取值)
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="openSearchModalBth" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
