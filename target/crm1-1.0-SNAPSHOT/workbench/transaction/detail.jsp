<%@ page import="com.bk.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.bk.crm.workbench.domain.Tran" %>
...
<script type="text/javascript">
	...
	* */
	...
	function changeIcon(stage,index1) {
		...
		} else {  // 如果当前阶段的可能性不为0 前7个绿圈, 绿色标记 黑圈 后两个一定是黑叉
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			if ("0".equals(currentPossibility)) {
				...
				for (int i = 0; i < dvList.size(); i ++) {
					...
					// 如果遍历出来的阶段的可能性为0, 说明是后两个, 一个是黑叉, 一个是红叉
		...
		<%
					...
					} else {  // 如果遍历出来的阶段可能性不为0, 说明是前七个, 一定是黑圈
		...
		<%
			...
			} else {  // 如果当前阶段可能性不为0, 前7个有可能是绿圈, 绿色标记, 黑圈, 后两个一定是黑叉
		...
		<%
					...
					} else {  // 如果遍历出来的阶段可能性不为0, 说明是前7个阶段 绿圈, 绿色标记, 黑圈
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 90px;">
			<div style="width: 300px; color: gray;">纪要</div>
			<div style="width: 630px;position: relative; left: 200px; top: -20px;">
				<b>
					&nbsp;${t.contactSummary}
				</b>
