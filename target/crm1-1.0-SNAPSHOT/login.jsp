        ...
        <script>
            ...
            $(function () {
                ...
                $(window).keydown(function (event) {
                    ...
                    // alert(event.keyCode);  // 获取敲下按键的键值

                    // 如果取得的键位的码值为13, 标识敲的是回车键
                    if (event.keyCode == 13) {
            ...
            // 普通的自定义的function方法, 一定要卸载$(function(){})的外面
            function login() {
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <%--
                            注意: 按钮卸载form表单中, 默认的行为就是提交表单
                                一定要将按钮的类型设置为button
                                按钮所触发的行为应该是由我们自己手动写js代码决定
                        --%>
                        <button type="button" id="submitBth" class="btn btn-primary btn-lg btn-block"  style="width: 350px; position: relative;top: 45px;">登录</button>
                    </div>
                </form>
            </div>
        </div>
