...
String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/";
	...
	Map<String, String> pMap = (Map<String, String>) application.getAttribute("pMap");  // getAttribute拿到的是Object, 所以需要强转
...
<html>
	...
	<script type="text/javascript">
		...
		$(function () {
			...
			* 		是一种一一对应的关系
			* 		一个阶段对应一个可能性
			* 		可以将阶段和可能行想象成是一种键值对之间的对应关系
			* 		以阶段为key, 通过选中的阶段, 出发可能行value
			*
			* 		stage			possibility
			* 		key				value
			* 		01资质审查		10
			...
			* */
			...
			$("#create-stage").change(function () {
				...
				// 取得选中的阶段
				var stage = $("#create-stage").val();  // this.value
		...
		<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
			...
			<div class="form-group">
				...
				<div class="col-sm-10" style="width: 300px;">
					...
					<input type="hidden" name="activityId" value="007589dc1f334593bcd4f24125e05d4c">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10" style="width: 300px;">
					...
					<input type="hidden" name="contactsId" value="d7cb781aca5a4b6daebeaa9fae776838">
				</div>
			</div>
