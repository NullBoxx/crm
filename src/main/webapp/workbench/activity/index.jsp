		...
		<script type="text/javascript">
			...
			$(function(){
						...
						success : function (data) {
                            ...
                            * */
							if (data.success) {
								...
								* 		但是表单的jquery对象, 没有为我们提供reset()方法让我们重置表单 (坑, idea为我们提示了由reset()方法)
								*
				...
				$("#searchBth").click(function () {
					...
					/*
					*
					* 	点击查询按钮的时候, 我们应该将搜索框中的内容保存起来, 保存到隐藏域当中
					*
					* */
			...
			*
			* 	我们都在哪些情况下, 需要调用pageList方法 (什么情况下需要刷新以下市场活动列表)
			* 		(1) 点击左侧菜单中的 "市场活动" 超链接的时候, 需要刷新市场活动列表, 调用pageList方法
			* 		(2) 添加, 修改, 删除后需要刷新市场活动列表, 调用pageList方法
			* 		(3) 点击查询按钮的时候, 需要刷新市场活动列表, 调用pageList方法
			* 		(4) 点击分页组件的时候, 调用pageList方法
			*
			* 	以上为pageList方法制定了六个入口, 也就是说, 在以上六个操作执行完毕后, 我们必须调用pageList方法, 刷新市场活动信息列表
			*
			* */
			...
			<div class="modal-dialog" role="document" style="width: 85%;">
				<div class="modal-content">
							...
							<div class="form-group">
								...
								<div class="col-sm-10" style="width: 81%;">
									<%--
										...
										关于文本域textarea
											(1) 一定是要以标签对的形式呈现, 正常状态下标签对要紧紧的按着
											(2) textarea虽然是以标签对的形式来呈现的, 但是它也是属于表单元素范畴
													我们所有的对于textarea的取值和复制操作, 应该统一使用val()方法 (而不是html()方法)
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" id="updateBth">更新</button>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="modal-dialog" role="document" style="width: 85%;">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						--%>
						<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						<button type="button" class="btn btn-primary" id="saveBth">保存</button>
					</div>
				</div>
			</div>
		</div>
			...
			<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
				...
				<div class="btn-toolbar" role="toolbar" style="height: 80px;">
					<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
					  ...
					  <button type="button" id="searchBth" class="btn btn-default">查询</button>
					...
					<div class="btn-group" style="position: relative; top: 18%;">
						<%--
							...
							data-target="#createActivityModal"
								表示打开哪个模态窗口, 通过以#id的形式找到该窗口

							现在我们是以属性和属性值的方式卸载了button元素中, 用来打开模态窗口
							但是现在这样是有问题的:
								问题在于没有办法对按钮的功能进行扩充
					  ...
					  <button type="button" class="btn btn-danger" id="deleteBth"><span class="glyphicon glyphicon-minus"></span> 删除</button>
					</div>
