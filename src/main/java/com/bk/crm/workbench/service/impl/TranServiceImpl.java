...
import com.bk.crm.workbench.dao.TranDao;
import com.bk.crm.workbench.dao.TranHistoryDao;
import com.bk.crm.workbench.domain.Customer;
...
//        通过以上对于客户的处理, 不论是查询出来已有的客户, 还是以前没有我们新增的客户, 总之客户已经有了, 客户的id已经有了
//        将客户id封装到t对象中
